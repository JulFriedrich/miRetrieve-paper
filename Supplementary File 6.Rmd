---
title: "miRetrieve NARGAB - Supplementary"
author: Julian Friedrich, Hans-Peter Hammes, Guido Krenning
date: "`r Sys.Date()`"
output:
...
```{r global}
# Set global options to hide messages and warnings to improve overview;
# center images
...
# Load atherosclerosis abstracts 
...
## Divide miRNAs depending on lettered suffixes
...
## Figure 1: Compare miRetrieve with PubMed's miRNA count
...
# Figure 2: Top miRNAs in atherosclerosis
...
# Figure 3: Top terms atherosclerosis
...
# Figure 4: Targets in atherosclerosis
...
# Figure 5: Top Terms Lung cancer
...
# Figure 6: Compare miR-21-term associations in atherosclerosis and lung cancer 
...
# Figure 7: Potential miRNA biomarker in atherosclerosis and lung cancer
...
# Extract chained miRNAs

```{r}
test_string <- "miR-221/222 are important in vasculature."

extract_mir_string(test_string)
```
